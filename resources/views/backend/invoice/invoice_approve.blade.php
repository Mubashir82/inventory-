        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Invoice Appreve</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-dark" width="100%">
                            <tbody>
                                <tr>
                                    ...
                                    <td><p>Name: <strong>{{ $payment['customer']['name'] ??'N/A' }}</strong></p></td>
                                    <td><p>Mobile: <strong>{{ $payment['customer']['mobile_no'] ??'N/A' }}</strong></p></td>
                                    <td><p>Name: <strong>{{ $payment['customer']['email'] ??'N/A' }}</strong></p></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td colspan="3">
                        ...
                        <form method="post" action="{{ route('approvel.store',$invoice->id) }}">
                            @csrf
                            <table class="table table-dark" width="100%"> 
                                <thead>
                                    <tr>
