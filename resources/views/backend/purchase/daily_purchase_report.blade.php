            ...
            <div class="row">
                <div class="col-md-4 form-group">
                    <div class="md-3">
                        ...
                        <input type="date" name="start_date" id="start_date" class="form-control  example-date-input" placeholder="YY-MM-DD">
                    </div>
                </div>
                ...
                <div class="col-md-4 form-group">
                    <div class="md-3">
                        ...
                        <input type="date" name="end_date" id="end_date" class="form-control  example-date-input" placeholder="YY-MM-DD">
                    </div>
                </div>
