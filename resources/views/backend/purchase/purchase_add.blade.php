                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    <label class="form-label" style="margin-top:20px;" >Category Name</label>
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    <label class="form-label" style="margin-top:20px;">Product Name</label>
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    <label class="form-label" style="margin-top: 70px;"> </label>
